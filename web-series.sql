...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-09-2022 a las 11:43:31
...
(36, 'Fleabag', 'Una joven de Londres, con dudosas intenciones y sexualmente activa, intenta lidiar con la vida en la gran ciudad mientras acepta una tragedia reciente que le ha cambiado. Esta creada y escrita por Phoebe Waller-Bridge, basado en su monólogo individual presentado por primera vez en 2013.', 'Fleabag.jpg', 'comedia', '1'),
...
INSERT INTO `usuarios` (`id_usuario`, `nombre_usuario`, `password_usuario`, `avatar`) VALUES
(1, 'rocio_92', '12345678', ''),
(2, 'rocio_92', '12345678', ''),
(3, 'rocio_92', 'asdsad', ''),
(4, 'rocio_92', 'fhtfh', ''),
(5, 'rocio_92', 'asasas', ''),
(6, 'rocio_92', 'sdsdsddsdsd', ''),
(7, 'rocio_92', 'werwerwer', ''),
(8, 'rocio_92', 'qweqwewe', ''),
(9, 'rocio_92', 'qweqwewe', ''),
(10, 'rocio_92', 'asqaaew', ''),
(11, 'rocio_92', 'kjhygtrew', ''),
(12, 'rocio_92', 'wqewqe', ''),
(13, 'rocio_92', '1234567', ''),
(14, 'rocio_92', 'asdasd', ''),
(15, 'rocio_92', 'asdasdsad', ''),
(16, 'rocio_92', 'sadasd', ''),
(17, 'rocio_92', '1234567', '');
...
--
ALTER TABLE `series`
  MODIFY `id_series` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
